...
function load_1Dlabels(vars)
    l = Dict()
    # Uppercase
    l["A_ice"] = L"$A_{ice}$ [$10^6$ km$\!^2$]"
    l["A_ice_f"] = L"$A_{ice,f}$ [$10^6$ km$\!^2$]"
    l["A_ice_g"] = L"$A_{ice,g}$ [$10^6$ km$\!^2$]"
    l["H_ice"] = L"$H_{ice}$ [m]"
    ...
    l["T_srf"] = L"$T_{srf}$ [K]"
    l["V_dT"] = L"$V_{T}$ []"
    l["V_ice"] = L"$V_{ice}$ [$10^6$ $\mathrm{km}^3$]"
    l["V_ice_f"] = L"$V_{ice,f}$ [$10^6$ $\mathrm{km}^3$]"
    l["V_ice_g"] = L"$V_{ice,g}$ [$10^6$ $\mathrm{km}^3$]"
    l["V_sle"] = L"$V_{ice}$ [mSLE]"
    l["V_sl"] = L"$V_{ice}$ [$10^6$ $\mathrm{km}^3$SLE]"

    # Lowercase
    l["bmb"] = L"$\frac{d m}{d t}_{base}$ [m$ \, \mathrm{yr}^{-1}]"
    l["bmb_g"] = L"$\frac{d m}{d t}_{base,g}$ [m$ \, \mathrm{yr}^{-1}]"
    l["bmb_shlf"] = L"$\frac{d m}{d t}_{base,shlf}$ [m$ \, \mathrm{yr}^{-1}]"
...
function load_3Dlabels(vars)
    l = Dict()
    l["H_ice"] = L"$H_{ice}$ [m]"
    l["H_ice_pd_err"] = L"$\Delta H_{ice}$ [m]"
    ...
    l["uxy_s_pd_err"] = L"$\Delta u_{xy,s}$ [m/s]"
